...
public class Megaminx extends TwistyPuzzle {
	...
	private PuzzleOption<Double> stickerGap = new DoubleSliderOption("gap", 30, 0, 100, 1000);
	private PuzzleOption<Double> cut_depth = new DoubleSliderOption("cut_depth", 50, 0, 100, 100);
	
	@Override
	public PuzzleOption<?>[] getDefaultOptions() {
		return new PuzzleOption<?>[] { stickerGap, cut_depth };
	}
