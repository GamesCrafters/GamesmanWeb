package edu.berkeley.gcweb.gui.gamescubeman.OskarsCube.ThreeD;
...
import edu.berkeley.gcweb.gui.gamescubeman.OskarsCube.MyShape;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(keys.contains(KeyEvent.VK_W)){
			if (!movement_key_held){
				...
				MyShape holder = (MyShape) shapes.get(0);
