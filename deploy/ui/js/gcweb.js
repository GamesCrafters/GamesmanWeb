            ...
            return {
                ...
                doMove: function(newMove){
                    ...
                    if(newMove.remoteness != undefined){
                        ...
                        text = '&nbsp;';
						$("#history-tree").append("<div class='mvh-row' style='background: transparent url(images/greendot.png) no-repeat right; width: "+width+"; text-align: right;'><span>"+text+"</span></div>").scrollTop(Number.MAX_VALUE);
                    }
